...
def boar_brawl(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    a = player_score % 10
    b = 0 if opponent_score < 10 else opponent_score % 100 // 10
    return max(1, 3 * abs(a - b))
    # END PROBLEM 2
...
def is_always_roll(strategy, goal: int = GOAL) -> bool:
...
def make_averaged(original_function, samples_count: int = 1000):
...
def max_scoring_num_rolls(dice=six_sided, samples_count: int = 1000):
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    sus_score = sus_update(0, score, opponent_score)
